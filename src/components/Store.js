    ...
    return (
        <div className="bg-white">
            <div onClick={() => {
                ...
                stopBodyScrolling()
            }} className={`blur-bg blur-bg-2 ${filteringMenu === true ? `` : `d-none`}`}></div>
            <Navbar/>
            <MobileToolbar/>
            <div className="container">
                <div className="d-flex justify-content-between my-3 p-2">
                    ...
                    <div className="fs-11 text-muted fw-bold">12 کالا</div>
                </div>
            </div>
            <div>
                <div className={`filtering-menu box-shadow position-fixed top-0 bottom-0 bg-white pt-2 ${filteringMenu === true ? `end-0` : `right-100`}`}>
                    <div className="container">
                ...
                <div>
                    <div
                        className="position-sticky top-65 mx-auto filter-wrapper">
                        <div className="d-flex gap-4 border-bottom p-2 container">
                            <div onClick={() => {
                                setFilteringMenu(prevState => !prevState)
                                stopBodyScrolling()
                            }}
                                 className="fs-11 fw-bolder d-flex align-items-center gap-2">
                                <span className="fs-5"><i className="fa-solid fa-sliders"></i></span>
                                فیلتر
                            </div>
                            <div className="fs-11 fw-bolder d-flex align-items-center gap-2">
