...
function Store() {
    const {stopBodyScrolling, categories} = useContext(AppContext)
        ...
        <div className="bg-white">
            ...
            <div className="container">
                <div className="d-flex justify-content-between my-3 p-2">
                    ...
                    <div className="fs-11 text-muted fw-bold">{numberToPersian(12)} کالا</div>
                </div>
            </div>
            <div>
                <div
                    className={`filtering-menu box-shadow position-fixed top-0 bottom-0 bg-white pt-2 ${filteringMenu === true ? `end-0` : `right--200`}`}>
                    <div className="container">
                ...
                <div className="d-flex gap-3 justify-content-between container">
                    <div className="col-3 border rounded my-2 d-none d-lg-block">
                        <div className="container pt-3 position-sticky top-0">
                            ...
                            <div className="filter-categories py-2 position-sticky top-0">
                                <h6 className="fs-6">دسته بندی‌های محصولات</h6>
                                <div>
                                    {
                                        categories.length ? getCategories(categories) : <></>
                    ...
                    <div className="col">
                        <div className="position-sticky top-65 mx-auto filter-wrapper">
                                ...
                                <div className="d-none d-lg-block">
                                    <div className="d-flex gap-2 align-items-center">
                                        ...
                                        <div
                                            ...
                                            <span onClick={(e) => {setSortingValue(e.currentTarget.innerHTML)
                                            }} role="button" className={`${sortingValue === "پربازدیدترین" ? `text-info` : ``}`}>پربازدیدترین</span>
                                            <span onClick={(e) => {setSortingValue(e.currentTarget.innerHTML)
                                            }} role="button" className={`${sortingValue === "جدیدترین" ? `text-info` : ``}`}>جدیدترین</span>
                                            <span onClick={(e) => {setSortingValue(e.currentTarget.innerHTML)
                                            }} role="button" className={`${sortingValue === "پرفروش‌ترین‌" ? `text-info` : ``}`}>پرفروش‌ترین‌</span>
                                            <span onClick={(e) => {setSortingValue(e.currentTarget.innerHTML)
                                            }} role="button" className={`${sortingValue === "ارزان‌ترین" ? `text-info` : ``}`}>ارزان‌ترین</span>
                                            <span onClick={(e) => {setSortingValue(e.currentTarget.innerHTML)
                                            }} role="button" className={`${sortingValue === "گران‌ترین" ? `text-info` : ``}`}>گران‌ترین</span>
                                        </div>
                                    </div>
                                </div>
                                <div onClick={() => {
                        ...
                        <div className="products-container container mb-3">
