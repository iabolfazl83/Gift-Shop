...
function Navbar() {
    const {loading, setLoading, stopBodyScrolling} = useContext(AppContext)
    ...
    return (
        <div className="navbar-wrapper box-shadow">
            ...
            <div className="container">
                <div className="mobile-header position-sticky top-0">
                    <div onClick={() => {
                        setMenuIsOpen(false)
                        stopBodyScrolling()
                    ...
                    <div
                        ...
                        <div
                            ...
                            <div className="mobile-menu-nav-item"><Link
                                className={`${useLocation().pathname === "/" ? `active-page` : ``}`} to={"/"}>صفحه
                                نخست</Link></div>
                    ...
                    <section
                        className="main-mobile-header px-2 d-flex justify-content-between align-items-center">
                    ...
                    <section className="header-nav-list d-flex justify-content-start pt-3">
                        ...
                        <nav className="d-flex justify-content-evenly gap-3 pe-3">
                            <div><Link className={`${useLocation().pathname === "/" ? `active-page` : ``}`}
                                       to={"/"}>خانه</Link></div>
                            <div><Link className={`${useLocation().pathname === "/contact-us" ? `active-page` : ``}`}
                                       to={"/contact-us"}>تماس با ما</Link></div>
