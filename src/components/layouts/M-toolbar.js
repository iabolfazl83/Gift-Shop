...
function MobileToolbar() {
    ...
    return (
        <div className="mobile-toolbar-menu box-shadow d-flex justify-content-between px-3 overflow-x-auto">
            ...
            <div className="mobile-toolbar-menu-item">
                <a href="">
                    <i className="fa-solid fa-heart d-block text-center mobile-toolbar-menu-icons position-relative"><span className="badge-icon">{numberToPersian(0)}</span></i>
                    علاقه مندی
                </a>
            </div>
            <div className="mobile-toolbar-menu-item">
                <a href="">
                    <i className="fa-solid fa-cart-shopping d-block text-center mobile-toolbar-menu-icons position-relative"><span className="badge-icon">{numberToPersian(8)}</span></i>
                    سبد خرید
                </a>
            </div>
            <div className="mobile-toolbar-menu-item">
