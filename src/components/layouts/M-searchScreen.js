    ...
    return (
        <div
            ...
            <div className="mobile-search-container d-flex py-2 align-items-center">
                <div className="close-search col-1">
                    <button className="btn p-0 m-0 border-0 d-flex" onClick={() => setScreenSearch(false)}>
                        <i className="fa-solid fa-arrow-right"></i>
                    </button>
                </div>
                <div className="mobile-search col-10 d-flex justify-content-start">
            ...
            <div className="search-options-container">
                <div className="recently-searched d-flex justify-content-start my-3">
                    <i className="fa-solid fa-clock-rotate-left col-1"></i>
                ...
                <div className="popular-searches d-flex justify-content-start my-3">
                    <i className="fa-solid fa-fire-flame-curved col-1"></i>
