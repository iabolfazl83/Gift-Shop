                    ...
                    <div className="mobile-header">
                        <div className="mobile-menu d-none">
                            ...
                            <div className="mobile-menu-nav-container">
                                <div className="mobile-menu-nav">صفحه نخست</div>
                                <div className="mobile-menu-nav">
                                    <span><i className="fa-solid fa-angle-left"></i></span>فروشگاه
                                ...
                                <div className="mobile-menu-nav">تماس با ما</div>
                                <div className="mobile-menu-nav">مجله دیجی شاپ</div>
                                <div className="mobile-menu-nav">درباره ما</div>
                                <div className="mobile-menu-nav"><i className="fa-solid fa-heart"></i> علاقه مندی</div>
                                <div className="mobile-menu-nav"><i className="fa-solid fa-user"></i> ورود / ثبت نام
                                </div>
                            </div>
                        </div>
                        <section className="main-mobile-header d-flex justify-content-between align-items-center">
                            ...
                            <div className="user-tools-mobile">
                                <a href="" className="px-2"><i className="fa-solid fa-user"></i></a>
                                <a href="" className="px-3"><i className="fa-solid fa-cart-shopping"></i></a>
                            </div>
                        </section>
                    </div>
                    ...
                    <div className="desktop-header">
                        ...
                        <section
                            ...
                            <div className="header-logo-desktop">
                                <img
                                    className="w-100"
                                    src={require("../src/assets/images/gift-shop-logo-design-love-gift-symbol-icon-gift-logo-design-template_657888-116-removebg.png")}
                                    alt=""/>
                            </div>
                        ...
                        <section className="header-nav-list d-flex justify-content-start gap-4 p-3">
                            ...
                            <nav className="d-flex justify-content-evenly gap-3">
                                ...
                                <div><a href="">فروشگاه</a><i className="fa-solid fa-angle-left px-1"></i></div>
                ...
                <footer>
                    <div className="footer-header">
                        ...
                        <div className="go-up-btn-container">
                            <button className="go-up-btn"> بازگشت به بالا<i className="fa-solid fa-angle-up"></i>
                            </button>
                        </div>
                    </div>
                        ...
                        <div className="shipping-info">
                            <svg width="55" height="54" viewBox="0 0 55 54" fill="none"
                                ...
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                      ...
                                      fill="#424750"/>
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                      d="M32.0558 17.55H36.4436V30.7125H32.0558V17.55Z" fill="#424750"/>
                                <path fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    <div className="footer-nav-container">
                        <div className="footer-nav-list-1">
                            <h5>با گیفت شاپ</h5>
                        ...
                        <div className="footer-nav-list-2">
                            <h5>خدمات مشتریان</h5>
                        ...
                        <div className="footer-nav-list-3">
                            <h5>راهنمای خرید از گیفت شاپ</h5>
                            <p>نحوه ثبت سفارش</p>
                            <p>رویه ارسال سفارش</p>
                            <p>شیوه‌های پرداخت</p>
                        </div>
                        <div className="footer-shop-verification">
                            <div className="verification-header">
                                <h5>اعتماد شما افتخار ماست</h5>
                                <p>اعتماد شما افتخار ماست</p>
                            </div>
                            <div className="verification-logos">
                                <div className="verification-log">
                                    <img src={require("./assets/images/enamad.png")} alt="enamad"/>
                                </div>
                                <div className="verification-log">
                                    <img src={require("./assets/images/samandehi.png")} alt="samandehi"/>
                                </div>
                            </div>
                        </div>
                    </div>

                    <div className="copywrite-rights">
                        <p>کلیه حقوق این وبسایت متعلق به گروه تجاری گیفت شاپ می باشد.</p>
                        <div className="bank-logos">
                            <img src={require("./assets/images/897987.png")} alt="bank logos"/>
                        </div>
                    </div>
                </footer>
            </div>
